          ...
          <div className="space-y-4">
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                ...
                subscribe once. What other options do you have to implement
                authentication without Firebase? Auth0, MongoDB, Passport, Okta,
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                PrivateRoute component is the blueprint for all private routes
                in the application. I f the user is logged in, go on and display
                the component in question; otherwise, redirect the user to
                sign-in page. Additionally, we can define the logic of isLogin
