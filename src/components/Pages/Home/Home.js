...
const Home = () => {
  ...
  return (
    <div className="">
      ...
      <iframe className="object-cover w-full h-56 rounded shadow-lg lg:rounded-none lg:shadow-none sm:h-96 lg:h-full"  src="https://embed.lottiefiles.com/animation/87979"></iframe>
